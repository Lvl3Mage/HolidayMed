	...
	<div class="fixed w-full h-full flex justify-center items-center">
		...
		<div class="card card-compact w-96 bg-base-100 shadow-xl">
			...
			<div class="card-body">
				...
				<InputLabel :validatedInput="usernameInput" :displayValidation="displayValidation">
					<template v-slot:label>Username</template>
					<Input ref="usernameInput" class="w-full" v-model="username" :validate="val => val != ''" :displayValidation="displayValidation">
				...
				<InputLabel :validatedInput="passwordInput" :displayValidation="displayValidation">
					<template v-slot:label>Password</template>
					<Input ref="passwordInput" class="w-full" v-model="password" :validate="val => val != ''" :displayValidation="displayValidation" type="password">
						<template v-slot:before>
